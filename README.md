...
截至当前，全库收录 **77 部典籍、4931 个结构化条目**，五术全覆盖，卜部三式齐备（奇门+六壬+太乙），卜部六爻四典齐备（火珠林+增删卜易+卜筮正宗+黄金策），山部丹道五典齐备（参同契+黄庭经+悟真篇+性命圭旨+钟吕传道集），山部养生四典齐备（易筋经+八段锦+五禽戏+太极），地相七大经典齐备（撼龙经+葬书+青囊奥语+雪心赋+博山篇+催官篇+地理人子须知），医部四大经典齐备（素问+灵枢+难经+伤寒论+金匮要略+神农本草经），白话精译覆盖4913篇（99.6%），质量门全部通过；
Release：v1.0（1547条）→ v2.0（3373条）→ v2.1（4430条）→ v2.2（4680条）→ v2.3（4808条，全库白话增强）→ v2.4（4857条，医部二书+地相二书+黄金策精译）→ v2.5（4908条，地理人子须知）→ v2.6（4913条，称骨入库+卜部白话精译）→ v2.7（4913条，白话精译大规模推进4895篇/99.6%）→ v2.8（4931条，钟吕传道集入库+医部白话精译完成）。
