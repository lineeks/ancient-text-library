...
conditions:
  ...
  pattern: []
  shensha: []
  keywords: ["方局", "三合", "三会", "寅午戌", "申子辰"]
weight: 9
tags: ["滴天髓阐微", "通神论", "方局", "方局", "三合"]
---
...
本篇论方与局：三字全为成方（寅卯辰之类），三合为局（亥卯未之类），方力厚而局之用多。方莫混局、局混方则有纯疵，行运之喜南喜北当看局中意向；若方局齐来、气势旺盛，须干头顺其气势、无反复（不杂逆局之神）方好；成方而干透元神，身已旺则生地、库地再帮皆非福，唯顺泄之运为美；成局而干透官星、官又虚脱无根，左右再逢生扶方局之字，则官愈衰而碌碌无成。原文主张方局混与不混本无所害，关键在干头能否引化、意向是否纯一。
