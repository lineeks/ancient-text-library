...
conditions:
  ...
  pattern: []
  shensha: []
  keywords: ["群兴", "富贵", "造化", "兴衰"]
weight: 6
tags: ["渊海子平", "赋论", "群兴论", "群兴", "富贵"]
---
...
本篇分当兴、崛起、聚兴、中兴、末兴五等论人兴衰：身主专旺、所用财官印食吉神各带禄得令不杂、又无刑冲、运途步步皆吉者为当兴，源清流洁终身享福；原局贵神得位合格而日主无力、逢运扶身使用神为我所用者勃然崛起；身旺杀纯无制、待运来制杀化权者为聚兴；比劫阳刃争旺、财官虚少、中年晚景逢杀运假杀为权制刃者为中兴；原局财官平生无气、至运到方兴富贵者为末兴。皆以原局成格与否、待运扶抑为机括。
