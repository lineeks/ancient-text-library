...
**【白话提要】**
本篇专论乾卦取象。乾为天，五行属金，方位西北，时令秋冬，数为一。乾卦基本取象：为天、为君、为父、为大人、为老人、为官、为贵、为金、为玉、为珠宝、为寒、为冰、为大赤、为良马、为老马、为瘠马、为驳马、为木果、为圆、为满、为始、为健、为刚、为动、为清、为贵、为高、为大、为上、为尊。在人物取象中，乾为君、为父、为大人、为老人、为官贵、为长者、为名人；在身体取象中，乾为首、为骨、为肺；在动物取象中，乾为马、为狮、为象；在器物取象中，乾为金玉、为珠宝、为圆物、为贵重之物；在方位取象中，乾为西北；在天时取象中，乾为天、为冰、为雹。占断时见乾卦，即依此取象推断：占人则为君父官贵，占物则为金玉珠宝，占病则为首疾骨疾，占方位则为西北，占天时则为晴寒。
