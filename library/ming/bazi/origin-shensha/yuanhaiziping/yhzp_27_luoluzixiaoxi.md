---
id: "yhzp_27_luoluzixiaoxi"
book: "渊海子平"
chapter: "赋论·第27篇"
chapter_num: 27
section_title: "珞琭子消息赋"
...
conditions:
  ...
  pattern: []
  shensha: []
  keywords: ["珞琭子", "消息", "古法", "赋文"]
weight: 6
tags: ["渊海子平", "赋论", "珞琭子消息赋", "珞琭子", "消息"]
---
...
本篇为渊源最古之禄命赋：天元一气禀清浊自然，干为禄以向背定贫富、支为命以顺逆循环，运行一辰十载、折除三日为年（二十四气七十二候），命有节气浅深。论将来者进成功者退、五行绝处有禄马（临绝建贵）、见不见之形无时不有、抽不抽之绪万古联绵；冬逢炎热夏草逢霜之反局、根苗花果、尊吉卑凶逢灾自愈/尊凶卑吉救疗无功、禄有三会灾有五期、背禄逐马守穷途、禄马同乡登八座、返吟伏吟天罗地网诸凶会当退避；复论凶中藏吉吉中藏凶、男迎女送、五行配仁义，主张通变神悟、十希得九。
