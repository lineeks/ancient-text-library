...
conditions:
  ...
  pattern: []
  shensha: []
  keywords: ["喜忌", "财官印", "格局", "归禄", "食神"]
weight: 6
tags: ["渊海子平", "赋论", "喜忌篇", "喜忌", "财官印"]
---
...
本篇为注解式赋文，先立四柱三才、专以日干配合八字支干、神煞相绊较量轻重之纲；随后逐句铺陈：时上七杀得月令制而干强则反为权印，财官印绶藏于月季，以及合禄、归禄（青云得路）、壬骑龙背、六乙鼠贵、井栏叉、刑合、子遥巳、丑遥巳、拱禄拱贵填实则凶、时上偏财、六阴朝阳等外格的成格条件与所忌方。正格方面论偏官宜制伏、去官留杀/去杀留官、戊日午月作印不作刃、建禄忌会杀、印绶忌财、阳刃忌时逢、官杀两停存喜弃憎等，终以五行罕测、须禀中和、不可一例而推收束。
