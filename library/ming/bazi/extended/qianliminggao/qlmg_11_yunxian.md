...
**【白话提要】**
本篇为「运限篇」，论述八字运限的原理与论断方法。运限者，运限也，为八字之大运流年。本篇论述运限的原理与论断方法：运限为八字之大运流年，为论断之依据；运限得当则论断准确，不当则论断不准确；运限需以实修验证，不可空谈运限；运限为八字之基，无运限则无八字论断。本篇还强调运限的特性：运限为八字之大运流年、为论断之依据、为八字之法；运限需以八字为依据，不以八字为依据则运限不当；运限为八字之基，无运限则无八字论断；运限需以实修验证，不可空谈运限。本篇还强调运限的论断方法：运限论断需先看八字，八字明则运限明；运限论断需以月令为依据，月令明则运限明；运限论断需以日干为核心，日干明则运限明；运限论断需以三看（八字、月令、日干）为基，无三看则无运限论断。本篇还强调运限的功效：运限论断得当则富贵贫贱可知，寿夭吉凶可测；运限论断得当则趋吉避凶，改命造运；运限论断得当则延年益寿，长生久视；运限论断得当则内外兼修，形神俱妙。本篇为千里命稿运限篇，为八字运限之法。
