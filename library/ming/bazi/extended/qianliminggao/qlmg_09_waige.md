...
conditions:
  ...
  hour_pillar: []
  ten_god: []
  pattern: ["从格", "化格", "从旺格", "从强格"]
  shensha: []
  keywords: ["外格", "特殊格局", "从化"]
weight: 2
tags: ["千里命稿", "韦千里", "民国通俗", "外格篇", "外格", "特殊格局"]
---
...
**【白话提要】**
本篇为「外格篇」，论述八字外格的原理与论断方法。外格者，外格也，为八字之特殊格局。本篇论述外格的原理与论断方法：外格为八字之特殊格局，为论断之依据；外格得当则论断准确，不当则论断不准确；外格需以实修验证，不可空谈外格；外格为八字之基，无外格则无八字论断。本篇还强调外格的特性：外格为八字之特殊格局、为论断之依据、为八字之法；外格需以八字为依据，不以八字为依据则外格不当；外格为八字之基，无外格则无八字论断；外格需以实修验证，不可空谈外格。本篇还强调外格的论断方法：外格论断需先看八字，八字明则外格明；外格论断需以月令为依据，月令明则外格明；外格论断需以日干为核心，日干明则外格明；外格论断需以三看（八字、月令、日干）为基，无三看则无外格论断。本篇还强调外格的功效：外格论断得当则富贵贫贱可知，寿夭吉凶可测；外格论断得当则趋吉避凶，改命造运；外格论断得当则延年益寿，长生久视；外格论断得当则内外兼修，形神俱妙。本篇为千里命稿外格篇，为八字外格之法。
