...
conditions:
  ...
  hour_pillar: []
  ten_god: []
  pattern: ["正官格", "七杀格", "财格", "印绶格", "食神格", "伤官格"]
  shensha: []
  keywords: ["格局", "成格破格", "取用"]
weight: 2
tags: ["千里命稿", "韦千里", "民国通俗", "格局篇", "格局", "成格破格"]
---
...
**【白话提要】**
本篇为「格局篇」，论述八字格局的原理与论断方法。格局者，格局也，为八字之八字格局。本篇论述格局的原理与论断方法：格局为八字之八字格局，为论断之依据；格局得当则论断准确，不当则论断不准确；格局需以实修验证，不可空谈格局；格局为八字之基，无格局则无八字论断。本篇还强调格局的特性：格局为八字之八字格局、为论断之依据、为八字之法；格局需以八字为依据，不以八字为依据则格局不当；格局为八字之基，无格局则无八字论断；格局需以实修验证，不可空谈格局。本篇还强调格局的论断方法：格局论断需先看八字，八字明则格局明；格局论断需以月令为依据，月令明则格局明；格局论断需以日干为核心，日干明则格局明；格局论断需以三看（八字、月令、日干）为基，无三看则无格局论断。本篇还强调格局的功效：格局论断得当则富贵贫贱可知，寿夭吉凶可测；格局论断得当则趋吉避凶，改命造运；格局论断得当则延年益寿，长生久视；格局论断得当则内外兼修，形神俱妙。本篇为千里命稿格局篇，为八字格局之法。
