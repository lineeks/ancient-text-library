...
本节为论干神之三，分六戊、六己、六庚、六辛、六壬、六癸逐一立论，每干先立歌诀、次标格局名目（如戊火数三、渊源滋养、相为庆会、金火相持、干鬼为殃，己之包成合禄、秀转逢生，庚之声誉远弛、相参成庆、禄害孤害，辛之威高志远、先凶后吉、禄气退休，壬之相呼集福、大奇绩贵、反凶成庆、天鬼相交，癸之互相福应、天鬼为滞等），详论各干真数、喜何五行以成格、忌何干为鬼、以何干解救，皆引《太乙统记》等书以五行辗转生克消息解之。
