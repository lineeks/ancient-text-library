...
**【白话提要】**
本篇为「论格局」，为神峰通考中的赋文，论述八字命理的论格局要旨。论格局者，论格局也，为八字命理之赋文。本篇论述论格局的要旨：论格局为八字命理之赋文，为论断之依据；论格局以赋文形式论述八字命理，为易于记诵之法；论格局需以实修验证，不可空谈论格局；论格局为八字命理之基，无论格局则无八字论断。本篇还强调论格局的特性：论格局为八字命理之赋文、为论断之依据、为易于记诵之法；论格局需以八字为依据，不以八字为依据则论格局不当；论格局为八字命理之基，无论格局则无八字论断；论格局需以实修验证，不可空谈论格局。本篇还强调论格局的论断方法：论格局论断需先看八字，八字明则论格局明；论格局论断需以月令为依据，月令明则论格局明；论格局论断需以日干为核心，日干明则论格局明；论格局论断需以三看（八字、月令、日干）为基，无三看则无论格局论断。本篇还强调论格局的功效：论格局论断得当则富贵贫贱可知，寿夭吉凶可测；论格局论断得当则趋吉避凶，改命造运；论格局论断得当则延年益寿，长生久视；论格局论断得当则内外兼修，形神俱妙。本篇为神峰通考论格局，为八字命理之赋文。
