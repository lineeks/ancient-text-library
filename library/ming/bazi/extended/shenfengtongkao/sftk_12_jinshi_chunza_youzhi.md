...
**【白话提要】**
本篇为「近时纯杂有制类」，论述八字近时纯杂有制的原理与论断方法。近时纯杂有制者，近时纯杂有制也，为八字之近格局纯杂。本篇论述近时纯杂有制的原理与论断方法：近时纯杂有制为八字之近格局纯杂，为论断之依据；近时纯杂有制得当则论断准确，不当则论断不准确；近时纯杂有制需以实修验证，不可空谈近时纯杂有制；近时纯杂有制为八字之基，无近时纯杂有制则无八字论断。本篇还强调近时纯杂有制的特性：近时纯杂有制为八字之近格局纯杂、为论断之依据、为八字之法；近时纯杂有制需以八字为依据，不以八字为依据则近时纯杂有制不当；近时纯杂有制为八字之基，无近时纯杂有制则无八字论断；近时纯杂有制需以实修验证，不可空谈近时纯杂有制。本篇还强调近时纯杂有制的论断方法：近时纯杂有制论断需先看八字，八字明则近时纯杂有制明；近时纯杂有制论断需以月令为依据，月令明则近时纯杂有制明；近时纯杂有制论断需以日干为核心，日干明则近时纯杂有制明；近时纯杂有制论断需以三看（八字、月令、日干）为基，无三看则无近时纯杂有制论断。本篇还强调近时纯杂有制的功效：近时纯杂有制论断得当则富贵贫贱可知，寿夭吉凶可测；近时纯杂有制论断得当则趋吉避凶，改命造运；近时纯杂有制论断得当则延年益寿，长生久视；近时纯杂有制论断得当则内外兼修，形神俱妙。本篇为神峰通考近时纯杂有制类，为八字近时纯杂有制之法。
