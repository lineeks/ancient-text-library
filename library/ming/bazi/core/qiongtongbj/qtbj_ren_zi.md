...
十一月壬水得阳刃帮身、比前月更旺，本节先取戊土、次用丙火；丙戊两透则富贵荣华，有戊无丙略可言富，有丙无戊则好谋无成。支成水局而丙不出干，纵有戊土也是庸人；丙透得所，即戊藏支也可显达，须运得用方妙。支成火局仅一富而已。比见于月时而年见丁火，是平常之辈；支成四库为富贵中人；丁出时干名为争合，主名利难成。壬子日丁未时虽不能科甲也有恩荣，因用子中癸水为宫、号曰用神得地，也主荣华。十一月壬水丙戊并用。
