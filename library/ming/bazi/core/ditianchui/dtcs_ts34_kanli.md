...
conditions:
  ...
  pattern: []
  shensha: []
  keywords: ["坎离", "水火", "南北", "子午"]
weight: 9
tags: ["滴天髓阐微", "通神论", "坎离", "坎离", "水火"]
---
...
本篇论坎离：坎水离火主宰天地之中气，成不独成，必有相持者在。水火相济，其相持之理有五：天干离衰、地支坎旺，须支有木使地气上升；天干坎衰、地支离旺，须干有金使天气下降；天干皆火、地支皆水，须木运以和之；天干皆水、地支皆火，须金运以解之；水火交战于干支，则视其强者岁运制之。明乎升降和解制五法，则无独成之势、反成水火既济、礼智相养之功。
