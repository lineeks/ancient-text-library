...
conditions:
  ...
  keywords: ["八格", "格局成败", "用神"]
weight: 9
tags: ["滴天髓阐微", "通神论", "八格", "正官格", "七杀格", "财格", "印绶格", "食神格", "伤官格", "八格", "格局成败"]
---
...
本篇论八格：财官印绶分偏正、兼论食伤，定为八格，乃命中正理——先观月令何支、次看天干透出何神、再究司令以定真假而后取用；月逢禄刃无格可取则另寻别支透干者为用。正格必兼五行常理（官印、煞印、财煞、食神制杀、食神生财、伤官佩印、伤官生财），变格必从五行气势（从财、从官杀、从食伤、从强从弱从势、一行得气、两气成形）。至于飞天合禄等影响遥系既为虚，杂气财官逢冲必发亦不可拘，六阴朝阳、鼠贵、骑龙背等外格与神煞纳音，原文一概斥为谬谈，劝人只详五行正理之格。
