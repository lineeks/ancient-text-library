...
conditions:
  ...
  pattern: []
  shensha: []
  keywords: ["顺逆之机", "神煞批判", "格局"]
weight: 9
tags: ["滴天髓阐微", "通神论", "知命", "顺逆之机", "神煞批判"]
---
...
本篇论知命之要：经文谓欲为人间开聋聩，顺逆之机必须理会。学命当察日主衰旺、究五行顺悖、审进退、论喜忌，关键全在一个用字——用之为财不可劫、用之为官不可伤、用之印绶不可坏、用之食神不可夺；若不为我用，则财官尽可伤、印食尽可坏。任氏痛斥不究用神而专以财官为美、以神煞奇格论命者，谓其与聋聩无异。
