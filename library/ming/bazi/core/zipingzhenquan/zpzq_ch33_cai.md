...
conditions:
  ...
  pattern: ["财格"]
  shensha: []
  keywords: ["财格", "财旺生官", "食神生财"]
weight: 10
tags: ["子平真诠", "论财", "财格", "正财", "偏财"]
---
...
本篇论财格：财为我克之物，又能生官，故为美格，主财帛、妻妾、才能、驿马。财喜根深而不宜太露，但透一位以清用，便不为露；若财旺生官，则露亦不忌（官护财，如府库钱粮有官看守）。财格贵局有：财旺生官（身强、不透伤、不混煞）、财用食生（身强、不露官、略带比）、财格佩印（孤财不贵，佩印帮身；财印宜相并而不相能）、食印并用而不相碍（或暗官去食护官）、财用伤官（财不旺而比强，透伤化劫，不得已而用）、财带七煞（合煞存财或制杀生财）、财用煞印（印化煞，忌党煞，冬土逢之尤贵）；又有壬生午、癸生巳单透财亦贵（月令暗官，或透丙藏戊弃煞就财）；劫刃太重则弃财就煞。各举命例为证。
