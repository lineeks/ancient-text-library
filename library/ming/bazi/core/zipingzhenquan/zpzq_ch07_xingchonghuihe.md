---
id: "zpzq_ch07_xingchonghuihe"
book: "子平真诠评注"
chapter: "第7章·论刑冲会合解法"
chapter_num: 7
section_title: "论刑冲会合解法"
...
本篇先释名：刑指三刑（子卯、巳申之类），冲指六冲（子午、卯酉之类），会指三会三合（申子辰之类），合指六合（子丑之类），皆就地支宫位对射而言。八字地支逢刑冲本非美事，而三合六合可以解之：如甲生酉月逢卯为冲，支有戌则卯戌合、有辰则酉辰合、有亥未则卯亥未会，皆使不冲；丙生子月逢卯为刑，亦可借戌合、丑合、亥未或申辰会而解。又有因解反得刑冲者（二卯不刑一子，戌合去一卯，反余一卯刑一子）；有会合不能解者（合住一处而他处复又刑冲）；更有以刑冲解刑冲者（用别位之刑冲分去月令官星所受之冲，月官犹在、其格不破）。种种变化，存乎其人。
