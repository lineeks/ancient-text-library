...
id: "zpzq_ch16_zaqi"
book: "子平真诠评注"
chapter: "第16章·论杂气如何取用"
chapter_num: 16
section_title: "论杂气如何取用"
...
conditions:
  ...
  pattern: ["杂气格"]
  shensha: []
  keywords: ["杂气", "辰戌丑未", "透干会支"]
weight: 9
tags: ["子平真诠", "论杂气如何取用", "杂气格"]
---
...
本篇论辰戌丑未四墓为杂气（所藏多、用神不一），取用却很简易：透干、会支取其清者，便杂而不杂。透干如甲生辰月，透戊取偏财、透癸取正印、透乙取月劫；会支如逢申子则会成水印；一透一用、兼透兼用、透会并用，合而有情者吉。有情是顺而相成（透干会支同向、两干相生且能清去暗土）；无情是逆而相背（透官却会成伤局、财印相合两失、官伤并透又会伤局）。更有有情而终成无情者（印格本喜泄秀，却火生暗土、或逢月冲使印难通月令，富而不贵）；有无情而终有情者（相克所去的恰是劫财、偏官，如月劫用官、食神带煞，反成美格，其局愈贵）。
