...
conditions:
  ...
  pattern: []
  shensha: []
  keywords: ["伤寒论", "医部", "张仲景", "六经辨证", "王叔和", "伤寒杂病论", "辨不可下病脉证并治", "不可下", "下法禁忌", "误下"]
weight: 5
